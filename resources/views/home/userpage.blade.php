...
<html>
   ...
   <body>
      ...
      <!-- end product section -->
      {{-- Commnet and reply section --}}
      <div style="text-align: center; padding-bottom:30px;">
         <h1
         style="font-size:30px; text-align:center;
         padding-top:20px; padding-bottom:20px;">Commnets</h1>
         <form action="{{ url('add_comment') }}" method="POST">
            @csrf
            <textarea style="height: 150px; width:600px" placeholder="commnet something ..."
            name="comment">
            </textarea>
            <br>
       ...
       @foreach ($comment as $comm)
         <div>
           <b>{{ $comm->name }}</b>
            ...
            data-Commentid="{{ $comm->id }}">Reply</a>
